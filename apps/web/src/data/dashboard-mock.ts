...
export const MOCK_CATEGORIES: MockCategory[] = [
  {
    id: '1',
    name: 'Backend',
    subcategories: ['NestJS', 'Postgres', 'Auth'],
    swatchColor: '#69B598',
    entryCount: 38,
    avgScore: 7.8,
  },
  ...
  },
  {
    id: '3',
    name: 'Reading',
    subcategories: ['DDIA', 'Refactoring'],
    swatchColor: '#B87DA2',
    entryCount: 22,
    avgScore: 7.5,
  },
  {
    id: '4',
    name: 'Side Project',
    subcategories: ['Grow Logs', 'Notes app'],
    swatchColor: '#C4A05E',
    entryCount: 19,
    avgScore: 8.4,
  },
  {
    id: '5',
    name: 'Soft Skills',
    subcategories: ['Communication', 'Mentoring'],
    swatchColor: '#B87060',
    entryCount: 12,
    avgScore: 6.9,
  },
